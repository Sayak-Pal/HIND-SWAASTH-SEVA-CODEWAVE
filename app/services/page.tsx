  ...
  const services = [
    {
      ...
      description:
        "Comprehensive medical consultation for all your health concerns with experienced general practitioners.",
      icon: Stethoscope,
              ...
              <CardHeader>
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-700 font-medium">{service.price}</p>
                  </div>
                </div>
                    ...
                    <ul className="space-y-1">
                      {service.features.map((feature, idx) => (
                        <li key={idx} className="text-sm text-gray-600 flex items-center">
                          <div className="w-1.5 h-1.5 bg-red-700 rounded-full mr-2"></div>
                          {feature}
                        </li>
                      ))}
                    </ul>
        ...
        <div className="mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Choose from our comprehensive health packages designed to meet your specific needs and budget. All
              packages include follow-up consultations and health reports.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {packages.map((pkg, index) => (
              <Card key={index} className={`relative ${pkg.popular ? "ring-2 ring-red-600 shadow-lg" : ""}`}>
                {pkg.popular && (
                ...
                <CardHeader className="text-center">
                  ...
                  <div className="mt-2">
                    <span className="text-3xl font-bold text-red-700">{pkg.price}</span>
                ...
                <CardContent>
                  ...
                  <Button
                    className={`w-full ${pkg.popular ? "bg-red-700 hover:bg-red-800" : ""}`}
