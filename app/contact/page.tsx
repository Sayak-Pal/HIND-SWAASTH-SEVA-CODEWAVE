              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-2">
                    ...
                    <p className="text-red-700">+91 1800-123-4567</p>
                    <p className="text-sm text-gray-600">Available 24/7</p>
                  </div>
                  <div className="mt-4 space-y-2">
                    <p className="font-medium">General Inquiries</p>
                    <p className="text-red-700">+91 11-2345-6789</p>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-2">
                    ...
                    <p className="text-red-700">info@hindswaasthseva.com</p>
                  </div>
                  <div className="mt-4 space-y-2">
                    <p className="font-medium">Appointments</p>
                    <p className="text-red-700">appointments@hindswaasthseva.com</p>
                  </div>
                  <div className="mt-4 space-y-2">
                    <p className="font-medium">Emergency</p>
                    <p className="text-red-700">emergency@hindswaasthseva.com</p>
                  </div>
                </CardContent>
              </Card>
