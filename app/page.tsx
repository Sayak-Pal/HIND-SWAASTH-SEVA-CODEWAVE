    ...
    <div className="min-h-screen bg-gradient-to-b from-red-50 to-white">
      ...
      <section className="relative py-20 px-4 text-center">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Additional Hero Section Brand Icons */}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-red-100">Expert Doctors</div>
            </div>
            <div>
              <div className="text-3xl font-bold mb-2">{stats.patients}+</div>
              <div className="text-red-100">Happy Patients</div>
            </div>
            <div>
              <div className="text-3xl font-bold mb-2">{stats.appointments}+</div>
              <div className="text-red-100">Appointments Booked</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => (
              <Card key={index} className="text-center hover:shadow-lg transition-shadow">
                <CardHeader>
                  <service.icon className="w-12 h-12 text-red-700 mx-auto mb-4" />
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                <Calendar className="w-8 h-8 text-red-700 mx-auto mb-2" />
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                <Heart className="w-8 h-8 text-red-700 mx-auto mb-2" />
                <CardTitle>Health Checkup</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4">Comprehensive health screening packages</p>
                <Link href={user ? "/book-appointment" : "/login"}>
                  <Button className="w-full bg-red-700 hover:bg-red-800">Schedule Checkup</Button>
                </Link>
              </CardContent>
            </Card>
